...
--
-- Name: global_stats; Type: TABLE; Schema: public; Owner: twitter; Tablespace: 
--
...
ALTER TABLE public.global_stats OWNER TO twitter;

--
-- Data for Name: global_stats; Type: TABLE DATA; Schema: public; Owner: twitter
--

COPY global_stats (id, nation, java, c, cplusplus, csharp, javascript, php, python, visual_basic, ruby, swift, html, scala, obj_c) FROM stdin;
